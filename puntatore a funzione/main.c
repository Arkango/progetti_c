...
int main()
{
    ...
    while (scelta != 8)
    {
        ...
        {
        case 0:
            printf("La somma dei due valori vale: %d \n", primoInput + secondoInput);
            break;
        case 1:
            printf("La sottrazione dei due valori vale:  %d \n", primoInput - secondoInput);
            break;
        case 2:
            printf("La moltiplicazione dei due valori vale:  %d \n", primoInput * secondoInput);
            break;
        case 3:
            if (secondoInput == 0)
                printf("Il divisore inserito non è valido\n");
            else
                printf("La divisione dei due valori vale:  %d \n", primoInput / secondoInput);
            break;
        case 4:
            printf("Minimo fra i due numeri:  %d \n", choose(&primoInput, &secondoInput, &min));
            break;
        case 5:
            printf("Massimo fra i due numeri:  %d \n", choose(&primoInput, &secondoInput, &max));
            break;
        case 6:
            printf("Media fra i due numeri:  %f \n", avg(primoInput, secondoInput));
            break;
  case 7:
